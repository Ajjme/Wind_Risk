...
cd /hpc/home/ajj54/ondemand/data/sys/dashboard/batch_connect/sys/bc_desktop/dcc/output/f09068d0-c36b-484f-a1d7-bbd186cdfbbe
...
create_yml () {
  ...
  (
    umask 077
    echo -e "host: $host\nport: $port\npassword: $password\ndisplay: $display\nwebsocket: $websocket\nspassword: $spassword" > "/hpc/home/ajj54/ondemand/data/sys/dashboard/batch_connect/sys/bc_desktop/dcc/output/f09068d0-c36b-484f-a1d7-bbd186cdfbbe/connection.yml"
  )
}
...
clean_up () {
  echo "Cleaning up..."
  [[ -e "/hpc/home/ajj54/ondemand/data/sys/dashboard/batch_connect/sys/bc_desktop/dcc/output/f09068d0-c36b-484f-a1d7-bbd186cdfbbe/clean.sh" ]] && source "/hpc/home/ajj54/ondemand/data/sys/dashboard/batch_connect/sys/bc_desktop/dcc/output/f09068d0-c36b-484f-a1d7-bbd186cdfbbe/clean.sh"
...
for i in $(seq 1 10); do
  ...
  VNC_OUT=$(vncserver -log "vnc.log" -rfbauth "vnc.passwd" $HTTPD_OPT -noxstartup -geometry 800x600 -idletimeout 0  2>&1)
...
[[ -e "/hpc/home/ajj54/ondemand/data/sys/dashboard/batch_connect/sys/bc_desktop/dcc/output/f09068d0-c36b-484f-a1d7-bbd186cdfbbe/before.sh" ]] && source "/hpc/home/ajj54/ondemand/data/sys/dashboard/batch_connect/sys/bc_desktop/dcc/output/f09068d0-c36b-484f-a1d7-bbd186cdfbbe/before.sh"


echo "Script starting..."
DISPLAY=:${display} "/hpc/home/ajj54/ondemand/data/sys/dashboard/batch_connect/sys/bc_desktop/dcc/output/f09068d0-c36b-484f-a1d7-bbd186cdfbbe/script.sh" &
SCRIPT_PID=$!

[[ -e "/hpc/home/ajj54/ondemand/data/sys/dashboard/batch_connect/sys/bc_desktop/dcc/output/f09068d0-c36b-484f-a1d7-bbd186cdfbbe/after.sh" ]] && source "/hpc/home/ajj54/ondemand/data/sys/dashboard/batch_connect/sys/bc_desktop/dcc/output/f09068d0-c36b-484f-a1d7-bbd186cdfbbe/after.sh"
